        ...
        <table class="table table-striped ">
            ...
            <tr>
                ...
                <td class="btn-group" role="group">
                    <div class="row">
                        <div class="col"><a href="{{route('contas.edit', ['associado_id' => $associado[0]['id'],'conta' => $conta['conta']])}}">
                        ...
                        <div class="col">
                            <a href="{{route('contas.delete', ['associado_id' => $associado[0]['id'], 'conta' => $conta['conta']])}}">
